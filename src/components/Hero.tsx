...
export default function Hero() {
  return (
    <div className="font-jakarta pt-30 flex flex-col items-center leading-6 md:px-12 px-6">
      <div className="grid lg:grid-cols-2 gap-3">
        <div className="flex flex-col">
          <h1
            className="text-2xl md:text-5xl font-bold whitespace-nowrap"
            id="top"
          >
            Hi, I'm Abdulbasit 👋
          </h1>
          ...
          <div className="my-3 flex gap-2">
            <a
              ...
              className={`text-white rounded-full p-3 hover:bg-[#d4d4d43c] border`}
            >
              <svg
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`text-[#b3b3b3] rounded-full p-3 hover:bg-[#d4d4d43c] border`}
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                x="0px"
            ...
            <a
              ...
              rel="noopener noreferrer"
              className={`text-white rounded-full flex items-center justify-center p-3 hover:bg-[#d4d4d43c] border`}
              target="_blank"
            >
              <svg
                width="28"
            ...
            <a
              className="border p-3 rounded-full hover:bg-[#d4d4d43c]"
              aria-label="reach me via my email"
