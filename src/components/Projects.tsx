...
export default function Projects() {
  ...
  const projectsInfos = [
    ...
    },
    {
      ...
      avif: "/portfolio.avif",
      webp: "/portfolio.webp",
      sitename: "Abdulbasit Adebajo",
      progress: "Completed",
      date: "Feb 2025",
      summary:
        "This is the current site. Key features are props generated project banners, auto detection of systems theme settings to toggle between light and dark theme, integrated vercel serverless feature to be able use nodemailer to send mails which I integrated in my contact form.",
      languages: [
        "React",
        "Tailwind CSS",
        "Nodemailer",
      ...
      links: [
        ...
        {
          url: "https://github.com/Twith2e/personal-portfolio-website",
          name: "GitHub",
          logo: (
            <svg
              xmlns="http://www.w3.org/2000/svg"
  ...
  return (
    <div
      className={`font-jakarta flex flex-col gap-5 md:px-12 ${
